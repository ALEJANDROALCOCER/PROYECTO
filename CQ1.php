...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id_cuestionario = 6; // ID fijo del cuestionario
...
// Pregunta 1
echo "<div class='question'><label>1. ¿Qué es el número atómico de un elemento?</label><br>";
...
// Pregunta 2
echo "<div class='question'><label>2. ¿Cómo se organizan los elementos en la tabla periódica?</label><br>";
